...
class MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.methodComboBox.addItem(_fromUtf8(""))
        self.methodComboBox.addItem(_fromUtf8(""))
        self.modeComboBox = QtGui.QComboBox(self.centralwidget)
        self.modeComboBox.setGeometry(QtCore.QRect(910, 690, 75, 33))
        ...
        self.modeLabel.setGeometry(QtCore.QRect(910, 670, 56, 17))
        ...
        self.lcdCells.setSegmentStyle(QtGui.QLCDNumber.Flat)
        self.lcdCells.setGeometry(QtCore.QRect(1290, 510, 64, 23))
        self.lcdCells.setObjectName(_fromUtf8("lcdCells"))
        self.lcdCellsPalette = self.lcdCells.palette()
        self.lcdCellsPalette.setColor(self.lcdCellsPalette.WindowText, QtGui.QColor(85, 85, 255))
        self.lcdBkgs = QtGui.QLCDNumber(self.centralwidget)
        self.lcdBkgs.setSegmentStyle(QtGui.QLCDNumber.Flat)
        self.lcdBkgs.setGeometry(QtCore.QRect(1290, 550, 64, 23))
        self.lcdBkgs.setObjectName(_fromUtf8("lcdBkgs"))
        self.lcdBkgsPalette = self.lcdBkgs.palette()
        self.lcdBkgsPalette.setColor(self.lcdBkgsPalette.WindowText, QtGui.QColor(85, 85, 255))
        self.lcdRedCells = QtGui.QLCDNumber(self.centralwidget)
        self.lcdRedCells.setSegmentStyle(QtGui.QLCDNumber.Flat)
        self.lcdRedCells.setGeometry(QtCore.QRect(1290, 590, 64, 23))
        self.lcdRedCells.setObjectName(_fromUtf8("lcdRedCells"))
        self.lcdRedCellsPalette = self.lcdRedCells.palette()
        self.lcdRedCellsPalette.setColor(self.lcdRedCellsPalette.WindowText, QtGui.QColor(85, 85, 255))
        self.lcdOthers = QtGui.QLCDNumber(self.centralwidget)
        self.lcdOthers.setSegmentStyle(QtGui.QLCDNumber.Flat)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.modeComboBox.setItemText(0, _translate("MainWindow", "reflect", None))
        self.modeComboBox.setItemText(1, _translate("MainWindow", "constant", None))
        self.modeComboBox.setItemText(2, _translate("MainWindow", "nearest", None))
        self.modeComboBox.setItemText(3, _translate("MainWindow", "mirror", None))
        self.modeComboBox.setItemText(4, _translate("MainWindow", "wrap", None))
